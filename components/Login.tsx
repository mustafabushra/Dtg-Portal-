      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
        <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden p-10">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex p-5 bg-white rounded-[2rem] shadow-xl shadow-amber-500/20 mb-6 text-slate-900 border border-slate-100">
              <img src="logo.png" alt="Dahran Logo" className="w-20 h-20 object-contain" onError={(e) => (e.currentTarget.src = 'https://placehold.co/200x200?text=DAHRAN')} />
            </div>
            <h1 className="text-3xl font-black text-slate-900">كافي برو</h1>
            <p className="text-xs font-bold text-slate-400 mt-2 uppercase tracking-[0.3em]">Enterprise Edition Cloud OS</p>
          </div>
          ...
          {loginMode === 'CHOICE' ? (
            <div className="space-y-4">
               <button 
                 ...
                 className="w-full p-6 bg-slate-900 text-white rounded-[2rem] flex items-center justify-between group hover:bg-amber-500 hover:text-slate-900 transition-all shadow-xl"
               >
               ...
               <button 
                 ...
                 className="w-full p-6 bg-white border-2 border-slate-100 text-slate-900 rounded-[2rem] flex items-center justify-between group hover:border-amber-500 transition-all shadow-lg"
               >
                 <div className="flex items-center gap-4">
                    <div className="p-3 bg-slate-50 rounded-2xl group-hover:bg-amber-50"><User className="w-6 h-6 text-slate-400 group-hover:text-amber-500" /></div>
                    <div className="text-right">
            ...
            <form onSubmit={handleLogin} className="space-y-6 animate-in slide-in-from-left-4 duration-500">
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="****"
                      required
                      className="w-full pr-12 pl-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none font-bold text-lg tracking-widest"
                    />
                  </div>
               </div>
               ...
               <button 
                 disabled={isLoading}
                 className="w-full py-5 bg-slate-900 text-white rounded-[2rem] font-black text-lg hover:bg-amber-500 hover:text-slate-900 transition-all shadow-2xl flex items-center justify-center gap-2"
               >
